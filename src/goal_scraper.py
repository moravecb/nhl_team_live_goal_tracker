...
def fetch_update(team_abbrv):
    ...
    for game in data['games']:
        ...
        elif game['status']['state'] == "PREVIEW" and (game['teams']['away']['abbreviation'] == team_abbrv or game['teams']['home']['abbreviation'] == team_abbrv):
...
def goal_scraper():
    ...
    parser.add_argument('-s', '--seconds', type=int, help="Enter the time to wait between fetches.", default=2)
